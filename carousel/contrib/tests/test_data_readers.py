...
"""
# long integers, see http://python-future.org/compatible_idioms.html#long-integers
from builtins import int  # why this need to be explicit?
...
H5TABLE = np.array(
    [(int(0), int(0), 15.200897216796875), (int(0), int(0), 14.545711517333984),
     (int(0), int(0), 13.890524864196777), (int(0), int(0), 13.540611267089844),
     (int(0), int(0), 13.190696716308594), (int(0), int(0), 12.942743301391602),
     (int(0), int(0), 12.904003143310547), (int(115), int(566), 14.073929786682129),
     (int(329), int(809), 15.947802543640137), (int(558), int(936), 18.07691764831543),
     (int(750), int(780), 20.15163803100586), (int(500), int(197), 20.636459350585938),
     (int(510), int(147), 21.00153350830078), (int(531), int(139), 21.318157196044922),
     (int(486), int(120), 21.44940757751465), (int(437), int(130), 21.36214256286621),
     (int(311), int(80), 21.034954071044922), (int(259), int(131), 20.530967712402344),
     (int(124), int(106), 19.722484588623047), (int(4), int(0), 18.716384887695312),
     (int(0), int(0), 17.36248207092285), (int(0), int(0), 16.008577346801758),
     (int(0), int(0), 14.654674530029297), (int(0), int(0), 13.30077075958252)],
    dtype=H5DTYPE
)
